...
import { sampleWithRequiredData } from '../interview.test-samples';
...
describe('Interview Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, InterviewComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to interviewService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInterviewIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInterviewIdentifier).toHaveBeenCalledWith(entity);
