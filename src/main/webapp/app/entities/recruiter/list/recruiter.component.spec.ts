...
import { sampleWithRequiredData } from '../recruiter.test-samples';
...
describe('Recruiter Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RecruiterComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.recruiters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to recruiterService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRecruiterIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRecruiterIdentifier).toHaveBeenCalledWith(entity);
