...
describe('Resume Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('Should load resume on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', ResumeDetailComponent);

      // THEN
      expect(instance.resume()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
