...
public interface ApplicationRepository extends ApplicationRepositoryWithBagRelationships, JpaRepository<Application, Long> {
    ...
    @Query(
        value = "select application from Application application left join fetch application.employer",
    ...
    @Query("select application from Application application left join fetch application.employer")
    List<Application> findAllWithToOneRelationships();

    @Query("select application from Application application left join fetch application.employer where application.id =:id")
